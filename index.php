...
/**
 ...
 ReadLika Bütün Haklarý Saklýdýr (2012-2013)

 Avatar Chat and all of its source code/files are protected by Copyright Laws. 
 The license for Avatar Chat permits you to install this software on a single domain only (.com, .co.uk, .tr.gp, .net, etc.). 
...
// install file is present
	...
	if(file_exists("install/index.php")){
		...
		die("Lütfen Ýnstall Klasörünü Silin.");
	}
...
// software licence is not found
	...
	if(!file_exists("software_licence.txt")){
		...
		die("Lütfen 'software_licence.txt' Dosyasýný Yükleyin.");
	}
...
// show register page
	...
	if($_GET['do'] == 'register' || $_POST['do'] == 'register'){
		...
		if($_POST && $_POST['do'] == 'register'){
			...
			if($reg=='1'){$eMessage = 'Tebrikler Basariyla Kayit Oldunuz - <a href="index.php">Hemen Giris Yapin</a>';}
